...
public class LocalizacaoService {
    ...
    public LocalizacaoResponseDTO responseDTO(Localizacao localizacao){
        return new LocalizacaoResponseDTO(localizacao.getId(), localizacao.getLatitude(), localizacao.getLongitude(), localizacao.getRegiao(), localizacao.getDescricao(), localizacao.getSensores());
    }
